...
from augmentation_transforms import _rotate_impl, _posterize_impl, _shear_x_impl, _shear_y_impl, _translate_x_impl, _translate_y_impl, _crop_impl, _solarize_impl, _cutout_pil_impl, _enhancer_impl, _hsv_h, _hsv_s, _hsv_v, _hed_h, _hed_e, _hed_d, _elastic, _gauss_noise, _scaling, _gauss_blur
...
def apply_policy(policy, img, aug_policy, dset, image_size, verbose=False):
  ...
  """
    ...
    if count != 0:
        #print('In apply policy,count ',count)
